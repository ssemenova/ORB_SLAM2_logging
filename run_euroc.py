...
for seq in seqs:
    ...
    for ratio in np.arange(0.5, 1.5, .1):
        ...
        run_string = "./Examples/Stereo/stereo_euroc Vocabulary/ORBvoc.txt Examples/Stereo/EuRoC.yaml {}/mav0/cam0/data {}/mav0/cam1/data Examples/Stereo/EuRoC_TimeStamps/{}  {} > {}/{}_connected.txt".format(sequence_full_path, sequence_full_path, timestamps, format_float, output_full_path, format_float)
